function viewItem(){
    ...
    .then(data => {
        ...
        for(items of data){
            ...
            item += '<div class="d-grid gap-4 d-md-block">'
            item += '<button class="btn btn-outline-dark" type="button">XS</button>'
            item += '<button class="btn btn-outline-dark" type="button">S</button>'
            item += '<button class="btn btn-outline-dark" type="button">M</button>'
            item += '<button class="btn btn-outline-dark" type="button">L</button>'
            item += '<button class="btn btn-outline-dark" type="button">XL</button>'
            item += '</div>'
            item += '</div>'
            item += '</div>'
            item += '</div>'
